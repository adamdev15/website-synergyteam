...
@section('title', 'Cara Pemesanan - Synergy Team')
    ...
    <div class="container py-5">
        <div class="row mb-5">
            <div class="col text-center">
                <h1 class="fw-bold" style="color:#0c54b7;">Cara Pemesanan Layanan</h1>
                <p class="text-muted">Ikuti langkah-langkah berikut untuk melakukan pemesanan</p>
            </div>
        </div>
